...
class TestPrefillAdmissionConfig(TestBase):
    def test_defaults_are_disabled_and_bounded(self):
        ...
        self.assertEqual(config.prefill_burst_cooldown_ms, 1000.0)
...
class TestSchedulerConfig(TestBase):
    ...
    def test_nested_config_overrides_all_scheduler_settings(self):
        config = SchedulerConfig(
            {
                "scheduler_config": {
                    ...
                    "prefill_admission_config": {
                        ...
                        "prefill_burst_cooldown_ms": 2500,
        ...
        self.assertEqual(config.prefill_admission_config.prefill_burst_cooldown_ms, 2500.0)
